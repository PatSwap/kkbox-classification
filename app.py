...
artists = ['BLACKPINK - Playing With Fire', 'Kodaline - The One', 'Coldplay - Everglow', 'The Weeknd - Losers', 'BANGTAN BOYS - For You',
       'Sammi Cheng - 落錯車', 'Angeline Wong - 默', 'Taylor Swift - Today Was A Fairytale',
       'Sugar Eyes - Saita Yao', 'Edward Chen - Hanya Kau Tuhan', 'Fang Shun Ji - 對你惜命命',
       'Ming Bridges - 別裝成還是朋友	', 'Park Heykyoung - Nerd Girl',
       'Jolin Tsai - Play我呸', 'Cake Poonyamund - ประโยคสั้นๆ', 'Amit Trivedi - Pareshaan',
       'A.R.Rahman - Idhu Naal',
       'Kishore Kumar - Ek Nazar Kisi Ne Dekha', 'Super 4 - 灰色控訴(TVB劇集「刑警」主題曲)']
...
with st.expander(label="How to generate a prediction"):
    st.write(
        """
        1. From the left hand sidebar, choose an artist/song of your choice
...
def main():
  ...
  def user_input():
    artist  = st.sidebar.radio(label ='Choose the song you\'ve listened to', options= list(temp_dict.keys()))
